 ...
 * Includes a fallback email/password auth for the headless testing subagent.
 */
                ...
                <div className="bg-sentinel-900 border border-sentinel-700 rounded-xl p-6">
                        ...
                        <form onSubmit={handleEmailSignIn} className="space-y-4">
                            <div>
                                <input
                                    ...
                                    className="w-full px-4 py-2 bg-sentinel-950 border border-sentinel-700 rounded-lg text-sm text-sentinel-100 placeholder-sentinel-500 focus:outline-none focus:border-blue-500"
                                />
                            </div>
                            <div>
                                <input
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer bg-blue-600 text-white hover:bg-blue-500 disabled:opacity-50"
                            >
                            ...
                            <button
                                ...
                                className="w-full text-xs text-sentinel-400 hover:text-sentinel-300 py-2 cursor-pointer"
                            >
                    ...
                    {!showEmailAuth && (
                        <div className="mt-4 pt-4 border-t border-sentinel-800">
                            <p className="text-xs text-center text-sentinel-500 mb-2">
                                Authorised accounts only. Access is verified via Google OAuth.
                            </p>
                            <button 
                                onClick={() => setShowEmailAuth(true)}
                                className="w-full text-xs text-center text-sentinel-600 hover:text-sentinel-400 cursor-pointer"
                            >
                                Use System Agent Login
                            </button>
                        </div>
                    )}
                </div>
