                        ...
                        <div className="mb-4">
                            ...
                            <div className="space-y-2.5">
                                {data.notable.map((event, i) => (
                                    <div key={`notable-${event.date}-${i}`} className="flex items-start gap-2">
                                    ...
                                    {data.earnings.map((entry, i) => (
                                        <div key={`earnings-${entry.date}-${i}`}>
                                            ...
                                            <div className="flex flex-wrap gap-1.5">
                                                {entry.tickers.slice(0, 3).map((ticker) => (
                                                    <span key={ticker} className="px-2 py-0.5 bg-sentinel-800 text-sentinel-200 text-xs font-bold rounded ring-1 ring-sentinel-700">
                                                        {ticker}
                                                    </span>
                                                ))}
